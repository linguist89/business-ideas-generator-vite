  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger asChild>
        <button className="solid-card-button">
          Show Offering Optimization
        </button>
      </Dialog.Trigger>
      <Dialog.Portal>
        ...
        <Dialog.Content className="ContextDialogContent">
          ...
          <Tabs.Root
            className="ContextTabsRoot"
            defaultValue="Consumer Pain Point"
          >
            <Tabs.List className="ContextTabsList" aria-label="How To Tabs">
              <Tabs.Trigger
                className="ContextTabsTrigger"
                value="Consumer Pain Point"
              >
                Consumer Pain Point
              </Tabs.Trigger>
            ...
            <Tabs.Content
              className="ContextTabsContent"
              value="Consumer Pain Point"
            >
              {content && (
                <p key={Math.random()}>{content["Consumer Pain Point"]}</p>
              )}
            </Tabs.Content>
